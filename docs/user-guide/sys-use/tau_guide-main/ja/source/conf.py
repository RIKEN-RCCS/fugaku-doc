...
latex_documents = [
    (master_doc, 'sphinx.tex', 'TAU利用ガイド',
     '理化学研究所計算科学研究センター', 'manual'),
]
...
rst_prolog= """
.. |post-k| replace:: スーパーコンピュータ「富岳」
.. |post-k-en| replace:: スーパーコンピュータ「富岳」
.. |post-k-only| replace:: 「富岳」
"""
