...
project = 'Supercomputer Fugaku Users Guide - TAU -'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'Supercomputer Fugaku Users Guide - TAU -',
     'RIKEN Center for Computational Science', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', 'Supercomputer Fugaku Users Guide - TAU -',
     [author], 1)
]
...
rst_prolog= """
.. |post-k| replace:: Supercomputer Fugaku
.. |post-k-en| replace:: Supercomputer Fugaku
.. |post-k-only| replace:: Fugaku
"""
