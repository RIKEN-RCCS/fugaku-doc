...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Supercomputer Fugaku User Guide －Language and development environment－  documentation")
)
