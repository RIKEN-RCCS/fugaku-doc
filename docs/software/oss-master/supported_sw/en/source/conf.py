...
project = 'Supported Software'
copyright = '2021, RIKEN Center for Computational Science'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'Using OSS',
