...
.. list-table::
   ...
   * - サポート内容
     - | 質問対応、バグ修正
       | https://github.com/genesis-release-r-ccs/genesis/issues
   * - ウェブページ
     - https://mdgenesis.org/
   * - 使い方
     - ``spack load genesis``
...
.. list-table::
   ...
   * - 概要
     - AlphaFold2系のオープンソース実装であるOpenFoldを、スーパーコンピュータ「富岳」のCPU超並列環境向けに実装・最適化したタンパク質立体構造推論ソフトウェア
   * - バージョン
     - ver1.0 (モノマー版)
   * - 開発チーム
     - HPC/AI駆動型医薬プラットフォーム部門・運用技術部門
   * - ライセンス
     - Apache License 2.0
   * - サポート内容
     - 質問対応
   * - ウェブページ
     - https://github.com/RIKEN-RCCS/openfold/tree/fugaku_v1
   * - 使い方
     - ``spack load openfold-for-fugaku``
   * - 問い合わせ先
     - openfold-for-fugaku@ml.riken.jp
